    ...
    <div class="col-md-7">
      <div class="profile_detail">
        ...
        <form method="post" enctype="multipart/form-data"  >
          ...
          <div class="img_browse">
            ...
            <div class="form-group">
              <div class="tg-fileuploadlabel">
                ...
                <input class="form-control-file text-capitalize imagem" id="imagem" type="file" name="imagen">
          ...
          <button class="change_btn mt-2 text-capitalize cadastrar" type="submit">Cadastrar10 </button>
        </form>
      </div>
    </div>
    <div class="col-md-5">
      <div class="change_password">
        ...
        <form>
          ...
          <button class="change_btn mt-2 text-capitalize" type="submit" value="button">ad aaapost</button>
        </form>
      </div>
    </div>
  </div>
